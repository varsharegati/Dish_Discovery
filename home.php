<div class="w-100 h-100">
    <header id="cover">
        <div class="container-fluid h-100 d-flex flex-column justify-content-end align-items-end">
            ...
            <div id="banner-site-title" class="w-100 text-center wow fadeIn" data-wow-duration="1.2s" style="font-family: Georgia; font-size: 4em; color: #FFFFFF !important;">Dish Discovery</div>
            </div>
        </div>
    </header>
